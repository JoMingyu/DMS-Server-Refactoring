...
public class ModifyRule implements Handler<RoutingContext> {
	...
	public void handle(RoutingContext ctx) {
		...
		MySQL.executeUpdate("UPDATE rule SET title=?, content=? WHERE no=?", title, content, no);
